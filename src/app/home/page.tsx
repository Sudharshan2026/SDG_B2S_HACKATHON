    ...
    <div className="space-y-8 pb-10">
      ...
      <section className="bg-slate-800 text-white rounded-xl p-6">
        ...
        <div className="flex flex-wrap items-center gap-3 mt-4">
          <Link
            href="/chatbot"
            className="inline-flex items-center gap-2 px-4 py-2 bg-white text-slate-800 text-sm font-medium rounded-lg hover:bg-slate-100"
          >
            <Bot size={18} />
            Ask AI Assistant
          </Link>
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 bg-slate-700 text-white text-sm font-medium rounded-lg hover:bg-slate-600 border border-slate-600"
          >
            <ArrowRight size={18} />
            About This Platform
          </Link>
